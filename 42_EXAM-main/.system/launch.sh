...
c++ .system/checkreadline.cpp -o .system/readline_ok 2>.system/.devmake.err &
...
if [ ! -f .system/readline_ok ]; then
    ...
    if [ ! -f .system/readline_ok ]; then
        ...
        if [ ! -f .system/readline_ok ]; then
            ...
            echo -ne "1. Check if c++ is installed\n"
...
c++ .system/exercise.cpp .system/main.cpp .system/menu.cpp .system/exam.cpp .system/utils.cpp .system/grade_request.cpp .system/data_persistence.cpp -lreadline -o .system/a.out >.system/.devmake.err 2>.system/.devmake.err &
PID=$!
...
# Vérification de c++
if ! check_package "c++"; then
    echo "Le compilateur c++ n'est pas installé sur votre système."
    echo "Veuillez l'installer pour continuer."
    exit 1
fi
